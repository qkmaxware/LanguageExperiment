 ...
 */
public class Pow implements AST{
    ...
    public Object Run(Scope parent) {
        ...
        if(left instanceof Numeric && right instanceof Numeric){
            return Numeric.Pow((Numeric)left, (Numeric)right);
        }else{
            throw new LiveException("Failed to exponentiate non-numeric values: "+left.toString()+" , "+right.toString());
        }
    }
